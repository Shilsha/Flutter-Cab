...
class _home_screen_1State extends State<home_screen_1> {
  ...
  LatLng roundTripSourceLatLang = LatLng(0, 0);
  LatLng roundTripMoreLatLang = LatLng(0, 0);
  LatLng roundTripDestinationLatLang = LatLng(0, 0);
  ...
  void _roundTripMarkers() async {
    ...
    if (widget.roundTripSourceCoordinates != null &&
      ...
      markers.add(
        Marker(
          markerId: MarkerId("round_trip_source_place"),
    ...
    if (widget.roundTripMoreCoordinates != null &&
      ...
      markers.add(
        Marker(
          markerId: MarkerId("round_trip_additional_place"),
    ...
    if (widget.roundTripDestinationCoordinates != null &&
      ...
      markers.add(
        Marker(
          markerId: MarkerId("round_trip_destination_place"),
  ...
  void _getRoundTripPolyline() async {
    ...
    if (roundTripResult.points.isNotEmpty) {
      roundTripResult.points.forEach((PointLatLng point) {
    ...
    setState(() {
      polylines.add(
        Polyline(
          polylineId: PolylineId("round_trip_poly"),
          color: Color.fromARGB(255, 97, 155, 4),
