              ...
              title: TextField(
                decoration: InputDecoration(
                    ...
                    hintStyle: GoogleFonts.poppins(
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
                        color: const Color.fromRGBO(59, 65, 86, 0.7))),
              ),
              subtitle: Transform.translate(
                  offset: const Offset(0, -10), child: const Divider()),
            ),
            Transform.translate(
              ...
              child: Padding(
                ...
                child: Align(
                    ...
                    child: Image.asset('assets/images/icons/dotted-line.png')),
              ),
            ),
            Transform.translate(
              offset: const Offset(0, -25),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Image.asset('assets/images/icons/vertical-line.png'),
                        Column(
                          children: [
                            Text(
                              'Return Date',
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset('assets/images/icons/search-places.png'),
                          const SizedBox(
                            width: 10,
                          ),
                          Text(
                            ...
                            style: GoogleFonts.openSans(
                                ...
                                fontSize: 15,
                                color: const Color.fromRGBO(217, 115, 122, 1)),
                          )
                        ],
                      ),
                    ),
